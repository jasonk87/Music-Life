...
class NPCWorldSimulator:
    ...
    def _maybe_emit_player_situation(self, npc):
        ...
        if shared_city and rel.respect >= 5 and rel.trust >= 3 and npc.momentum >= 1 and collab_key not in player.active_opportunities and player_reliability >= -2 and (player_visibility + npc_visibility) >= 2:
        ...
        if rel.rivalry >= 8 and npc.momentum >= 3 and rivalry_key not in player.active_opportunities and (player_visibility + npc_visibility) >= 1:
