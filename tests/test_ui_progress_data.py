...
class TestUiProgressData(unittest.TestCase):
    def test_career_overview_data_reflects_player_progress(self):
        ...
        game.player.current_location = Location("City Center", "Scene hub")
        ...
        game.player.schedule.add_event(start, end, event.name, "Gig", {"event_id": event.event_id})
        ...
        self.assertEqual(data["opportunities"][0]["value"], "Ready")
        self.assertEqual(data["opportunities"][2]["value"], "12 fame to go")
